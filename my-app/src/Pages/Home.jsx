...
return (
    <div class="animated-background h-screen w-screen p-0">
        <div className="bg-gray-800 text-white shadow-2xl w-full h-full flex flex-col lg:flex-row overflow-hidden">
            ...
            <div className="w-full lg:w-1/3 p-6 sm:p-9 bg-gray-900 flex flex-col justify-center border-r border-gray-700">
                ...
                <button
                    ...
                    className="w-full py-3 px-4 text-white font-semibold rounded-lg shadow-lg gradient-button border-2 border-blue-500"
                    disabled={isLoading}
                >
            ...
            <div className="w-full lg:w-2/3 p-4 sm:p-6 flex flex-col justify-between">
                <div id="chat-window" className="chat-window chat-container flex flex-col space-y-4 p-4 mb-3 border border-gray-700 rounded-lg overflow-y-auto bg-gray-700 flex-grow">
